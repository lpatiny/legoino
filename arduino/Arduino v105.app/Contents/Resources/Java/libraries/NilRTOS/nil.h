...
/** Enable debug version of port_halt */
#define NIL_DBG_ENABLED                 TRUE
#else
/** Disable debug version of port_halt */
...
#define NIL_THREADS_TABLE_BEGIN()                                           \
  const ThreadConfig nil_thd_configs[] = {
#else  /* WHG_MOD */
#define NIL_THREADS_TABLE_BEGIN()                                           \
...
#define nilThdSleepS(time)                                                  \
  nilSchGoSleepTimeoutS(nil.currp, TRUE, nilTimeNowS() + time)
#else /* WHG_PATCH */
#define nilThdSleepS(time)                                                  \
 ...
 * @sclass
 */
#define nilTimeNowS() (nil.systime)
#else  /* WHG_PATCH */
/**
 * @brief   Current system time.
 * @details Returns the number of system ticks since the @p nilSysInit()
...
#if WHG_MOD
extern const ThreadConfig nil_thd_configs[];
