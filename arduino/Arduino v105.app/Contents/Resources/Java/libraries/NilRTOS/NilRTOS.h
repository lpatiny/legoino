...
#define NIL_RTOS_VERSION 20130520
//------------------------------------------------------------------------------
/**
 ...
 *                      non-negative
 */
#define SEMAPHORE_DECL(name, n) Semaphore name = {n}
 ...
 */
#define nilIsIdleThread() (nil.currp == nil.idlep)
...
#endif
  void boardInit();
  cnt_t nilSemGetCounter(Semaphore *sp);
  bool_t nilSysBegin(void);
  bool_t nilSysBeginNoFill();
