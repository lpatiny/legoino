...
void printResult(char* data, Print* output) {
  ...
  switch (data[0]) {
      ...
      break;
             case 'd':
      printDifferences(output);
      break;
            case 'e':
      printConsecutive(output);
      break;
      case 'f':
...
void printHelp(Print* output) {
  //return the menu
  output->println(F("(c)lear results"));
  output->println(F("print (d)ifferences"));
  output->println(F("print cons(e)cutive"));
  output->println(F("(f)ree"));
  output->println(F("(h)elp"));
  output->println(F("(l)og"));
  output->println(F("(p)rint results"));
