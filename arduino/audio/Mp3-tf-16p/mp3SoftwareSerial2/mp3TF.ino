...
void mp3TF::increaseVolume() {
	static uint8_t play_cmd [10] = { 0X7E, 0xFF, 0x06, 0X05, 00, 00, 00, 0xFE, 0xee, 0XEF};
	sendCmd (play_cmd);
}

void mp3TF::setVolume(uint8_t volume) {
	static uint8_t play_cmd [10] = { 0X7E, 0xFF, 0x06, 0X06, 00, 00, 0x30, 0xFE, 0xEE, 0XEF};
...
void mp3TF::reset() {
	static uint8_t pause_cmd [] = { 0X7E, 0xFF, 0x06, 0x0C, 00, 00, 00, 0xFE, 0xED, 0XEF};
	sendCmd (pause_cmd);
}
